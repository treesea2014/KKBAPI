 ...
 * @version 1.0.0
 * @date 2015.09.06
 * @decription 用户信息查询 by id 123.57.210.46:8080/gxb-api/user/userId
 * 
 */
public class GetUserInfoById {
	...
	public void test() {
		...
		response.then().log().all().assertThat().statusCode(200).body("userId", equalTo(541513))
				.body("username", equalTo("yguo")).body("students.userId", Matchers.hasItem(541513))
				.body("students.schoolId", Matchers.hasItem(247)).body("students.tenantId", Matchers.hasItem(223));
	}
