...
public class GetAssignmentById {
    ...
    public void test(){
        ...
        Response response =  TestConfig.getOrDeleteExecu("get","/class_assignment/"+assignmentId+"?loginUserId=123");
    ...
    public void testWithItemIdNotExist(){
        Response response =  TestConfig.getOrDeleteExecu("get","/class_assignment/-1?loginUserId=123");
        response.then().log().all()
                .assertThat().statusCode(200)
                .body(equalTo(""));
    }
