...
public class CreateTopicTest {
	...
	public void VerifyCorrectData() {
		...
		Response response = TestConfig.postOrPutExecu("post",
				"/units/" + unitid + "/topics?access_token=" + access_token, jsonObject);
	...
	public void VerifyInvalidAccesstoken() {
		...
		Response response = TestConfig.postOrPutExecu("post",
				"/units/" + unitid + "/topics?access_token=qwq11", jsonObject);
	...
	public void VerifyNullAccesstoken() {
		...
		Response response = TestConfig.postOrPutExecu("post",
				"/units/" + unitid + "/topics?access_token=" + null, jsonObject);
		response.then().assertThat().statusCode(401).body("status", equalTo(false)).body("message",
				equalTo("无效的access_token"));
	}
	...
	public void VerifyEmptyAccesstoken() {
		...
		Response response = TestConfig.postOrPutExecu("post",
				"/units/" + unitid + "/topics?access_token=", jsonObject);
	...
	public void VerifyInvalidUnitid() {
		...
		Response response = TestConfig.postOrPutExecu("post",
				"/units/" + "a1" + "/topics?access_token=" + access_token, jsonObject);
	...
	public void VerifyEmptyUnitid() {
		...
		Response response = TestConfig.postOrPutExecu("post",
				"/units/" + "/topics?access_token=" + access_token, jsonObject);
		response.then().assertThat().statusCode(404);
	}
