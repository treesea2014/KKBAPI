...
public class ModifyAttachmentTest {
	private int userid = 930668;
	private int tenantsid = 10;
	private int attachmentid = 20;
	...
	public void VerifyCorrectData() {
		...
		Response response = TestConfig.postOrPutExecu("put",
				"/attachments/" + attachmentid + "?access_token=" + access_token, jsonObject);
	...
	public void VerifyInvalidAccesstoken() {
		...
		Response response = TestConfig.postOrPutExecu("put",
				"/attachments/" + attachmentid + "?access_token=qwe12", jsonObject);
	...
	public void VerifyNullAccesstoken() {
		...
		Response response = TestConfig.postOrPutExecu("put",
				"/attachments/" + attachmentid + "?access_token=" + null, jsonObject);
		response.then().assertThat().statusCode(401).body("status", equalTo(false)).body("message",
				equalTo("无效的access_token"));
	}
	...
	public void VerifyEmptyAccesstoken() {
		...
		Response response = TestConfig.postOrPutExecu("put",
				"/attachments/" + attachmentid + "?access_token=", jsonObject);
	...
	public void VerifyInvalidAttachmentid() {
		...
		Response response = TestConfig.postOrPutExecu("put",
				"/attachments/" + "qa12" + "?access_token=" + access_token, jsonObject);
	...
	public void VerifyEmptyAttachmentid() {
		...
		Response response = TestConfig.postOrPutExecu("put",
				"/attachments/"  + "?access_token=" + access_token, jsonObject);
		response.then().assertThat().statusCode(404);
	}
