...
public class ModifyPageTest {
	...
	public void VerifyCorrectData() {
		...
		Response response = TestConfig.postOrPutExecu("put",
				"/pages/" + pageid + "?access_token=" + access_token, jsonObject);
	...
	public void VerifyInvalidAccesstoken() {
		...
		Response response = TestConfig.postOrPutExecu("put",
				"/pages/" + pageid + "?access_token=test123", jsonObject);
	...
	public void VerifyNullAccesstoken() {
		...
		Response response = TestConfig.postOrPutExecu("put",
				"/pages/" + pageid + "?access_token=" + null, jsonObject);
		response.then().assertThat().statusCode(401).body("status", equalTo(false)).body("message",
				equalTo("无效的access_token"));
	}
	...
	public void VerifyEmptyAccesstoken() {
		...
		Response response = TestConfig.postOrPutExecu("put",
				"/pages/" + pageid + "?access_token=", jsonObject);
	...
	public void VerifyInvalidPageid() {
		...
		Response response = TestConfig.postOrPutExecu("put",
				"/pages/" + "qwe11" + "?access_token=" + access_token, jsonObject);
	...
	public void VerifyEmptyPageid() {
		...
		Response response = TestConfig.postOrPutExecu("put",
				"/pages/"  + "?access_token=" + access_token, jsonObject);
		response.then().assertThat().statusCode(404);
	}
...
//				"/units/" + pageid + "/pages?access_token=" + access_token, jsonObject);
//		response.then().assertThat().statusCode(400).body("status", equalTo(false));
//	}
