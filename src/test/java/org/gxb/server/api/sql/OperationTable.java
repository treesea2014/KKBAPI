...
public class OperationTable {
	...
	public Map<String,Object> selectCourseChapter(int courseid) throws Exception {
		...
		String sql = "select content_type, count(*) as totalcount from course_chapter where course_id = "+courseid+" group by content_type;";
		DBConnection dbc = null;
		Connection conn = null;
		Statement st = null;
		ResultSet res = null;
	...
	public int selectCourseChapter(int courseid,String contentType) throws Exception {
		String sql = "select count(*) as totalcount from course_chapter where course_id = "+courseid+" and content_type = '"+contentType+"'";
		DBConnection dbc = null;
		Connection conn = null;
		Statement st = null;
		ResultSet res = null;
	...
	public int selectCourseUnitStatus(int courseid,int status) throws Exception {
		String sql = "select count(*) as totalcount from course_unit where course_id = "+courseid+" and status = "+status+"";
		DBConnection dbc = null;
		Connection conn = null;
		Statement st = null;
		ResultSet res = null;
	...
	public int selectCourseItemStatus(int courseid,int status) throws Exception {
		String sql = "select count(*) as totalcount from course_item where course_id = "+courseid+" and status = "+status+"";
		DBConnection dbc = null;
		Connection conn = null;
		Statement st = null;
		ResultSet res = null;
	...
	public int selectCourseChapterStatus(int courseid,int status) throws Exception {
		String sql = "select count(*) as totalcount from course_chapter where course_id = "+courseid+" and status = "+status+"";
		DBConnection dbc = null;
		Connection conn = null;
		Statement st = null;
		ResultSet res = null;
	...
	public int selectCourseQuizStatus(int courseid,int status) throws Exception {
		String sql = "select count(*) as totalcount from course_quiz where course_id = "+courseid+" and status = "+status+"";
		DBConnection dbc = null;
		Connection conn = null;
		Statement st = null;
		ResultSet res = null;
	...
	public int selectCourseTopicStatus(int courseid,int status) throws Exception {
		String sql = "select count(*) as totalcount from course_topic where course_id = "+courseid+" and status = "+status+"";
		DBConnection dbc = null;
		Connection conn = null;
		Statement st = null;
		ResultSet res = null;
	...
	public int selectCourseAssignmentStatus(int courseid,int status) throws Exception {
		String sql = "select count(*) as totalcount from course_assignment where course_id = "+courseid+" and status = "+status+"";
		DBConnection dbc = null;
		Connection conn = null;
		Statement st = null;
		ResultSet res = null;
	...
	public int selectCourseCoursewareStatus(int courseid,int status) throws Exception {
		String sql = "select count(*) as totalcount from course_courseware where course_id = "+courseid+" and status = "+status+"";
		DBConnection dbc = null;
		Connection conn = null;
		Statement st = null;
		ResultSet res = null;
	...
	public int selectCoursePageStatus(int courseid,int status) throws Exception {
		String sql = "select count(*) as totalcount from course_page where course_id = "+courseid+" and status = "+status+"";
		DBConnection dbc = null;
		Connection conn = null;
		Statement st = null;
		ResultSet res = null;
