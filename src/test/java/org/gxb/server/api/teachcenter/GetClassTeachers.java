 ...
 * http://w-api-f2.kaikeba.cn/classes/2083/enrollment_teachers?access_token=1aace0664359768b607e63b55cd8ed72
 * 
 */
public class GetClassTeachers {
    ...
    public void test(){
		Response response= TestConfig.getOrDeleteExecu("get","/classes/"+classid+"/enrollment_teachers?access_token="+token);
       ...
       response.then().
               ...
               body("data.id", Matchers.hasItems(541513)).
               body("data.name", Matchers.hasItem("尚帝"));
    ...
    public void testErrToken01(){
		Response response= TestConfig.getOrDeleteExecu("get","/classes/"+classid+"/enrollment_teachers?access_token=xx");
       response.then().
    ...
    public void testErrToken02(){
		Response response= TestConfig.getOrDeleteExecu("get","/classes/"+classid+"/enrollment_teachers?access_token=");
       response.then().
               assertThat().statusCode(401).
    ...
    public void testErrClassid01(){
       ...
       response.then().
               ...
               body("status",equalTo(false)).body("message", equalTo("课程不存在"));
    }
