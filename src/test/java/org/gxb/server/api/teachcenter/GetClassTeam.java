 ...
 * http://w-api-f2.kaikeba.cn/classes/2083/teams?access_token=1aace0664359768b607e63b55cd8ed72
 * 
 */
public class GetClassTeam {
    ...
    public void testPage(){
		Response response= TestConfig.getOrDeleteExecu("get","/classes/"+classid+"/teams?access_token="+token+"&curPage=2&pageSize=5");
       response.then().
               assertThat().statusCode(200).
               body("status",equalTo(true)).
