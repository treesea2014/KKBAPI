...
public class SaveSubmission {
	private static Logger logger = LoggerFactory.getLogger(SaveSubmission.class);
	...
	public void verifyCorrectParams() {
		...
		if (response.getStatusCode() == 500) {
			logger.info("save submission接口##" + response.prettyPrint());
		}

		response.then().assertThat().statusCode(200);
		Assert.assertEquals(Boolean.parseBoolean(response.prettyPrint()), true, "save submission失败");
	}
	...
	public void verifySubmittedType_002() {
		...
		jsonObject.put("contextType", "Course");
		jsonObject.put("submittedId", 4230);
		jsonObject.put("submittedType", "Page");
		jsonObject.put("userId", 123456);
		jsonObject.put("assetList", assetListArray);
