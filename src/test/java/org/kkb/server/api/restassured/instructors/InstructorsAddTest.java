 ...
 * @date 2015.09.06
 * <p>建课-新增讲师
 * http://w-api-f1.kaikeba.cn/tenants/1"+tenant_id+"/instructors?access_token=79415208f5cab7101d1fcadc922f6ef7
 * </p>
 * 
 */
public class InstructorsAddTest {
	
	private final static Logger logger = LoggerFactory.getLogger(InstructorsAddTest.class);
